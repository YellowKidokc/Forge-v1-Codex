...
export async function registerRoutes(
  ...
  app.post("/api/ai/chat", async (req, res) => {
    try {
      ...
      // Fetch the axiom to build context
      ...
      // Build context block from axiom data
      ...
      // Mock AI response for first pass — includes real axiom context
      // This is the contract surface; swap for real provider later
